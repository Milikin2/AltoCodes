(() => {
    ...
    class SelectConstructor {
        ...
        getSelectTitleValue(selectItem, originalSelect) {
            ...
            if (originalSelect.hasAttribute("data-search")) return `<span class="pseudo__placeholder">Пермь, Пермский край, Россия</span> <div class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput}"></span> </div>`; else {
    ...
    if (purchase__body) {
        ...
        if (region__select) {
            ...
            if (pseudo__placeholder && select__input) {
                const select__options = document.querySelectorAll(".select__option");
                select__input.addEventListener("input", (function(e) {
                    for (let i = 0; i < select__options.length; i++) console.log(123);
                }));
            }
        }
    }
